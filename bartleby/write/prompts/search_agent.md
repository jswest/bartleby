...
2. Search with targeted queries. Try multiple phrasings if initial results are sparse.
3. Use `get_chunk_window` to read promising passages in full context.
4. Return a synthesis of what you found, citing sources with bracket notation [1], [2], etc. using the `ref` numbers from search results.
