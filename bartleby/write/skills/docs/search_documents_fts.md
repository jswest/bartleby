...
**Important:** This searches within individual text chunks (~800 characters each). All search terms must appear in the SAME chunk to match. For multi-term queries, keep it simple:
